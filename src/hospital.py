...
class MobileHospital(Hospital):
    ...
    def assign_bed(self, patients: list) -> tuple:
		...
		for i in range(len(patients)):
			if available_bed <= patients[-i-1]: # odd way of coding. It'll be more natural to put old patients at the beginning of the list and append new patients to the end of the list as a convention. 
